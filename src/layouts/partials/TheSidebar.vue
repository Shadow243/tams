                ...
                <div id="sidenav-menu">
                    ...
                    <!-- <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#dashboards" aria-expanded="false"
                                aria-controls="dashboards" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#ecommerce" aria-expanded="false"
                                aria-controls="ecommerce" class="side-nav-link">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="apps-ecommerce-product-add.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="apps-ecommerce-product-add">Add Product</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="apps-ecommerce-order-add.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="apps-ecommerce-order-add">Add/Edit Order</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="inventory">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="apps-ecommerce-purchased-orders.html"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#more-apps" aria-expanded="false"
                                aria-controls="more-apps" class="side-nav-link">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="auth-card-success-mail.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-card-success-mail">Success Mail</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="auth-card-delete-account.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-card-delete-account">Delete Account</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="auth-split-success-mail.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-split-success-mail">Success Mail</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="auth-split-delete-account.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-split-delete-account">Delete Account</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="datatables">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="tables-datatables-fixed-columns.html"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="tables-datatables-column-searching.html"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="tables-datatables-rows-add.html" class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="tables-datatables-rows-add">Add Rows</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="tables-datatables-checkbox-select.html"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="second-level-2">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a data-bs-toggle="collapse" href="#menu-item-4"
                                                        aria-expanded="false" aria-controls="menu-item-4"
                                                        class="side-nav-link">
